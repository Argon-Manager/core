...
import { MutationCreateSprintArgs, QuerySprintArgs, QuerySprintsArgs } from '../app/generated'
...
export default class SprintsResolver {
  ...
  @Query()
  @UseGuards(AuthGuard)
  sprint(@Args() { id }: QuerySprintArgs) {
    return this.sprintsService.findById(parseInt(id))
  }
